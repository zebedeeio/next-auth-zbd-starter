          ...
          {data.map((prize) => (
            <li key={prize[0]}>
              ...
              <Image
                ...
                />
                <div>
                  <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">{prize[0]}</h3>
                  <p className="text-sm font-semibold leading-6 text-indigo-600">{prize[1]}</p>
                </div>
              </div>
            </li>
          ))}
